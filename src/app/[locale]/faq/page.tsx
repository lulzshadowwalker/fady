...
const faqs = [
  ...
  { question: 'Where can I buy a recharge card?', answer: 'Recharge cards are available at most convenience stores and online.' },
  {
        ...
        >
          {faqs.map(({ question, answer }, index) => (
            <motion.div key={index} variants={itemVariants}>
              <details name="faq" className="border-t border-b border-secondary-content px-4 py-7">
