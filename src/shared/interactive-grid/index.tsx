...
function getRandomColor() {
  const colors = ['secondary', 'base', 'primary', 'transparent', 'transparent', 'transparent'];
          ...
          row.map((color, colIndex) => {
            ...
            return (
              <div
                ...
                className={clsx('w-10 h-10 rounded-none transition-opacity duration-200', {
                  'bg-secondary/70': color === 'secondary',
